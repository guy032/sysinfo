 ...
 */
function parseBluetoothType(str: string): string {
  let result = '';
 ...
 */
function parseBluetoothManufacturer(str: string): string {
 ...
 */
function parseBluetoothVendor(str: string): string | null {
 ...
 */
function parseLinuxBluetoothInfo(
  lines: string[],
...
/**
 * Parse Darwin (macOS) bluetooth devices
 */
interface IDarwinBluetoothObject {

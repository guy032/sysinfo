 ...
 */
export function getFilesInPath(source: string): string[] {
  /**
   ...
   */
  function isDirectory(src: string): boolean {
   ...
   */
  function getDirectories(src: string): string[] {
    return fs
      .readdirSync(src)
   ...
   * @returns {string[]} Array of file paths
   */
  function getFilesRecursively(src: string): string[] {
    try {

...
import {
  ...
  wifiInterfaces,
  wifiNetworks,
} from './src/promise/lib';

// Type definition for WinRM options
...
// Type definition for system information results
 ...
 */
export async function getStaticInfo(options: WinRMOptions): Promise<SystemInfoResult> {
  const results: SystemInfoResult = {};
 ...
 */
export async function getDynamicInfo(options: WinRMOptions): Promise<SystemInfoResult> {
  const results: SystemInfoResult = {};
 ...
 */
export async function getAllInfo(options: WinRMOptions): Promise<SystemInfoResult> {

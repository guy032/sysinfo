...
const bluetooth_vendors_1 = tslib_1.__importDefault(require("../../mapping/bluetooth-vendors"));
...
function getBluetoothScriptPath() {
    ...
    return path_1.default.resolve(__dirname, '../../powershell/bluetooth.ps1');
}
/**
...
function parseBluetoothVendor(str) {
    ...
    if (!Number.isNaN(id)) {
        return bluetooth_vendors_1.default[id] || null;
    }
    return null;
}
/**
        ...
        process.nextTick(async () => {
            ...
            if (platform._linux) {
                ...
                for (const element of btFiles) {
                    const filename = path_1.default.basename(element);
                ...
                try {
                    const hdicon = (0, child_process_1.execSync)('hcitool con', util.execOptsLinux).toString().toLowerCase();

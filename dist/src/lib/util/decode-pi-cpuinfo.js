...
const hex2bin_1 = tslib_1.__importDefault(require("./hex2bin"));
...
function decodePiCpuinfo(lines) {
    ...
    const revisionCode = (0, get_value_1.default)(lines || [], 'revision', ':', true);
    const model = (0, get_value_1.default)(lines || [], 'model:', ':', true);
    const serial = (0, get_value_1.default)(lines || [], 'serial', ':', true);
    let result = {
        model: '',
        serial: '',
        revisionCode: '',
    ...
    if (Object.prototype.hasOwnProperty.call(oldRevisionCodes, revisionCode)) {
        ...
        // new revision code
        const revision = ('00000000' + (0, get_value_1.default)(lines || [], 'revision', ':', true).toLowerCase()).slice(-8);
        const memSizeCode = Number.parseInt((0, hex2bin_1.default)(revision.slice(2, 3)).slice(5, 8), 2) || 0;
...
exports.default = decodePiCpuinfo;

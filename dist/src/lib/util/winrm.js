...
exports.winRMSingleShell = winRMSingleShell;
exports.winRMBatch = winRMBatch;
exports.winRMWorkload = winRMWorkload;
 ...
 */
async function winRMSingleShell(cmds, opts) {
 ...
 */
function winRMWorkload(cmd, opts) {
    if (!cmd || cmd.trim() === '') {
 ...
 */
async function executeSingleCommand(cmd, opts) {
    if (!cmd || cmd.trim() === '') {
        return '';
    }
    try {

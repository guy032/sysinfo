...
exports.strIsNumeric = strIsNumeric;
/**
...
function plistParser(xmlStr) {
    ...
    let inTagEnd = false;
    const metaData = [{ tagStart: '', tagEnd: '', tagContent: '', key: null, data: null }];
    let c = '';
    let cn = xmlStr[pos];
    while (pos < len) {
        c = cn;
...
function strIsNumeric(str) {
    return (typeof str === 'string' && !Number.isNaN(Number(str)) && !Number.isNaN(Number.parseFloat(str)));
}
/**

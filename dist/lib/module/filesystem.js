 ...
 */
export function fsSize(options, callback) {
    const { _linux, _freebsd, _openbsd, _netbsd, _darwin, _sunos, _windows } = getPlatformFlagsFromOptions(options);
...
export function fsOpenFiles(options, callback) {
        ...
        process.nextTick(async () => {
            ...
            if (_linux) {
                ...
                if (result.allocated === null) {
                    ...
                    try {
                        result.allocated = Number.parseInt(execSync(cmd, { maxBuffer: 1024 * 1024 }).toString(), 10);
                    }
                    catch {
                        util.noop();
                    }
...
export function blockDevices(options, callback) {
    const { _linux, _darwin, _windows } = getPlatformFlagsFromOptions(options);
    return new Promise((resolve) => {
        process.nextTick(async () => {
            const result = [];
...
export function fsStats(options, callback) {
    const { _linux, _windows, _freebsd, _openbsd, _netbsd, _sunos } = getPlatformFlagsFromOptions(options);
    return new Promise((resolve) => {
        process.nextTick(async () => {
...
export function disksIO(options, callback) {
    const { _linux, _darwin, _windows } = getPlatformFlagsFromOptions(options);
    return new Promise((resolve) => {
        process.nextTick(async () => {
            const result = [];
...
export function diskLayout(options, callback) {
    const { _linux, _darwin, _windows } = getPlatformFlagsFromOptions(options);
    return new Promise((resolve) => {
        process.nextTick(async () => {
            const result = [];
